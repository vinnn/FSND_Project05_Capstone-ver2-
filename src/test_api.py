...
class CastingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # self.database_path = "sqlite:///{}".format(os.path
        #       .join(self.project_dir, self.database_filename))
        # setup_db(self.app)   #, self.database_path)
    ...
    def test_200_get_actors(self):
        ...
        self.assertTrue(data[0]['actors'])  # check the result
        # contains 'actors' dictionary
    ...
    def test_200_get_movies(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data[0]['success'], True)
        self.assertTrue(data[0]['movies'])  # check the result
        # contains 'actors' dictionary
